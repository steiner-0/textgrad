...
class DeepseekThinkingEfficiencyLoss(Module):
    ...
    def __init__(self, 
        ...
        self.format_string = (
            ...
            "and adopt a more concise thinking process. Your feedback should help design a system prompt that guides the model "
            "to solve problems with fewer tokens while maintaining accuracy."
        )
