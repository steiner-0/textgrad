...
def config():
    ...
    parser.add_argument("--accuracy_weight", type=float, default=0.1, help="Weight for accuracy.")
    parser.add_argument("--token_weight", type=float, default=0.9, help="Weight for token efficiency.")
